      ...
      <div className="glass-panel-heavy rounded-2xl px-3 md:px-4 py-2 flex items-center justify-between border border-slate-700/60 shadow-2xl backdrop-blur-xl gap-2 w-full">
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          <Link to="/" className="flex items-center gap-2 text-slate-100 hover:text-white transition-colors shrink-0" aria-label="Acoustic Shield Home">
            ...
            <span className="font-display text-base tracking-tight font-light text-slate-100 hidden sm:inline">
              Acoustic Shield
            </span>
          </Link>
          ...
          <div className="relative shrink-0" ref={dropdownRef}>
            <motion.button
              ...
              className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 text-white border border-indigo-400/40 px-2.5 py-1.5 rounded-xl text-xs font-mono font-medium transition-all shadow-md shadow-indigo-600/30 cursor-pointer"
              aria-label="3D Background Mode Menu"
            >
              <Layers className="w-3.5 h-3.5 text-indigo-200" />
              <span>3D: {activeModeObj.label}</span>
            ...
            <AnimatePresence>
              {isOpen && (
                <motion.div
                  ...
                  className="absolute left-0 mt-2 w-56 bg-slate-900/95 border border-slate-700/80 rounded-2xl p-1.5 shadow-2xl backdrop-blur-2xl z-50 flex flex-col gap-1"
                >
