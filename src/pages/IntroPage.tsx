...
export const IntroPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0e0d0c] text-[#e8e6e3] flex flex-col font-sans overflow-x-hidden selection:bg-[#10b981]/30 selection:text-[#10b981]">
      {/* Background WebGL Natural Soundwave Shader */}
      <UltrasonicShader />

      {/* CRT Scanline Overlay */}
      <div className="fixed inset-0 scanline pointer-events-none z-10 opacity-20" />

      {/* Main Container */}
      <main className="relative z-20 flex flex-col min-h-screen">
        {/* Top HUD */}
        <header className="w-full flex justify-between items-center px-6 py-4 border-b border-white/10 bg-[#141312]/80 backdrop-blur-md">
          <div className="flex items-center gap-4 font-mono text-[10px] uppercase text-[#9e9a93] tracking-widest">
          ...
          <div className="font-mono text-[10px] uppercase text-[#9e9a93] tracking-widest font-bold">
        ...
        <section className="flex flex-col items-center justify-center px-margin-page text-center pt-16 pb-8">
          <div className="max-w-4xl flex flex-col items-center animate-slide-up-blur">
            <div className="font-mono text-[10px] text-[#9e9a93] tracking-[0.2em] uppercase mb-4 border border-white/10 px-4 py-1 bg-[#1c1a18] backdrop-blur-md">
              PRO-EDITION v4.0
            </div>

            <h1 className="font-display-lg-mobile md:font-display-lg text-[#f4f3f1] tracking-tighter uppercase mb-3 font-bold">
              Acoustic Shield
            </h1>

            <h2 className="font-mono text-sm md:text-base text-[#10b981] tracking-widest uppercase mb-6">
              Unveiling The Unheard
            </h2>

            <p className="font-mono text-xs md:text-sm text-[#9e9a93] max-w-2xl mx-auto uppercase tracking-widest border border-white/10 bg-[#1c1a18]/80 backdrop-blur-md px-6 py-3 rounded mb-8">
              <span className="text-[#10b981] animate-pulse mr-2">●</span> Operational Status: Vigilance Active // System Alpha
            </p>

            <Link to="/login">
              <button className="group relative bg-[#1c1a18] backdrop-blur-md text-white border border-white/20 font-mono text-sm uppercase tracking-[0.2em] px-10 py-5 hover:bg-white/10 hover:border-white/40 transition-all duration-300 shadow-sm cursor-pointer">
                <span className="absolute top-1 right-2 text-[8px] text-[#9e9a93] opacity-50 group-hover:opacity-100 transition-opacity">0x7F</span>
        ...
        <section className="w-full max-w-[1400px] mx-auto px-margin-page pb-24 relative z-20">
          <div className="flex items-center gap-4 mb-8 border-b border-white/10 pb-4">
            <span className="material-symbols-outlined text-[#10b981]">group</span>
            <h3 className="font-headline-md text-headline-md text-[#f4f3f1] uppercase tracking-tight font-bold">
              The Acoustic Team
            </h3>
          ...
          {/* Bento Grid for Team */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border border-white/10 bg-[#141312]/80 backdrop-blur-md relative overflow-hidden rounded-lg p-6">
            {/* Team Member 1 */}
            <div className="relative p-6 border border-white/10 bg-[#1c1a18] hover:bg-[#23211f] transition-colors duration-300 group rounded-lg overflow-hidden flex flex-col justify-between">
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex flex-col flex-grow font-mono">
                  <div className="text-[10px] text-[#9e9a93] mb-1 tracking-widest uppercase">ID: CN-0984</div>
                  ...
                  <div className="w-full space-y-1 mt-auto pt-4 border-t border-white/10 text-[11px]">
                    <div className="flex justify-between items-center text-[#9e9a93]">
            ...
            <div className="relative p-6 border border-white/10 bg-[#1c1a18] hover:bg-[#23211f] transition-colors duration-300 group rounded-lg overflow-hidden flex flex-col justify-between">
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex flex-col flex-grow font-mono">
                  <div className="text-[10px] text-[#9e9a93] mb-1 tracking-widest uppercase">ID: EV-0721</div>
            ...
            <div className="relative p-6 border border-white/10 bg-[#1c1a18] hover:bg-[#23211f] transition-colors duration-300 group rounded-lg overflow-hidden flex flex-col justify-between">
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex flex-col flex-grow font-mono">
                  <div className="text-[10px] text-[#9e9a93] mb-1 tracking-widest uppercase">ID: PP-0899</div>
